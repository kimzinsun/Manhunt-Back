...
class CommentController(@Autowired val commentService: CommentService) {
    ...
    @GetMapping("/list")
    fun findAllComment(boardId: Int): ResponseEntity<Response<List<CommentDTO>>> {
        val comment = commentService.findAllComment(boardId)
        return ResponseEntity.ok().body(Response.success(comment))
    }

    @PostMapping("/insert")
    fun insertComment(commentDTO: CommentDTO): ResponseEntity<ResponseUnit> {
    ...
    @PostMapping("/delete")
    fun deleteComment(userId: Int, commentId: Int): ResponseEntity<ResponseUnit> {
    ...
    @PostMapping("/update")
    fun updateComment(@RequestBody commentDTO: CommentDTO, @RequestParam userId: Int): ResponseEntity<ResponseUnit> {
